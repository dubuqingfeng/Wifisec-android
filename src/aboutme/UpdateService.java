...
public class UpdateService extends Service {
	...
	public int onStartCommand(Intent intent, int flags, int startId) {
		...
		updatePendingIntent = PendingIntent.getActivity(this, 0, updateIntent,
				0);
		// 设置通知栏显示内容
		updateNotification.icon = com.ndsec.wifisec.R.drawable.ic_launcher;
			...
			while ((readsize = is.read(buffer)) > 0) {
				...
				if ((downloadCount == 0)
					...
					updateNotification.contentView = new RemoteViews(
							getPackageName(), com.ndsec.wifisec.R.layout.notification_item);
					updateNotification.contentView.setTextViewText(
							com.ndsec.wifisec.R.id.notificationTitle, "正在下载");
					updateNotification.contentView.setProgressBar(
							com.ndsec.wifisec.R.id.notificationProgress, 100, downloadCount, false);
